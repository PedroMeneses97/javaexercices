public class Main {
    ...
    public static void main(String args[]) {
        ...
        Author author1 = new Author("Donald E. Knuth");
        book1.setAuthor(author1);
        Author author2 = new Author("Joshua Bloch");
        book2.setAuthor(author2);
        Author author3 = new Author("Robert C. Martin");
        ...
        book1.getLstReviews().add(new Review("Review 1",4.4));
        book1.getLstReviews().add(new Review("Review 2",1.4));
